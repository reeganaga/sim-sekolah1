...
<div style="margin:0 auto;width:800px;">
	...
	<tr><th colspan="3" class="tl">Laporan Data Siswa SMAN 6 BS</th></tr>
</table>

<br />
<table width="750" align="center" border="0" cellpadding="0" cellspacing="0" class="krs_box">
	<tr><th width="30">NO</th><th>NIS</th><th width="200">Nama Siswa</th>
		<th width="90">Tanggal Lahir</th><th width="150">Alamat</th><th width="70">Telpon</th><th width="150">Nama Ayah</th></tr>
		<?php 
		$nomor=1 ;
		$siswa=$murid->tampilsiswa();
			foreach ($siswa as $siswabs) {
		 ?>
		<tr>	
			<td><?php echo $nomor; ?></td>
			<td><?php echo $siswabs['nis']; ?></td>
			<td style="text-align:left;"><?php echo $siswabs['nama_siswa']; ?></td>
			<td style="text-align:left;"><?php echo $siswabs['tanggal_lahir']; ?></td>
			<td style="text-align:left;"><?php echo $siswabs['alamat']; ?></td>
			<td><?php echo $siswabs['telpon']; ?></td>
			<td style="text-align:left;"><?php echo $siswabs['nama_ayah']; ?></td>					
			</tr>
		<?php 
		$nomor ++;
		} ?>
